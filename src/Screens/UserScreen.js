...
export default function UserScreen ({navigation,route}){
    ...
    return(
        ...
        <View style={{width:'100%',height:'40%',backgroundColor:'#ffffff'}}>
          <View style={{height:'70%',backgroundColor:'#4CAF50'}}>
          ...
          <Text style={{color:'#b6b6b8',fontSize:16,alignSelf:'center',marginBottom:10}}>{email}</Text>
          </View>
        </View>
        ...
        <MaterialIcons
            ...
            <TouchableOpacity 
              ...
              { text: "YES", onPress: () => {AsyncStorage.clear();
                ...
                style={{backgroundColor:'#4CAF50',width:'80%',alignSelf:'center',height:50,borderRadius:10,flexDirection:'column',justifyContent:'center',marginTop:50}}>
